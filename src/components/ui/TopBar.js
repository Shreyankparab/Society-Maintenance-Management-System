    ...
    <header className="topbar" style={{ left: sidebarWidth || 0 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
        ...
        <div>
          ...
          {subtitle && (
            <p style={{ fontSize: "0.7rem", color: "var(--text-dim)", marginTop: "0.12rem" }}>{subtitle}</p>
          )}
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          {notifOpen && (
            <div style={{ ...dropdownBase, width: 320, overflow: "hidden" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            <span style={{ fontSize: "0.82rem", fontWeight: 600, color: "var(--text-secondary)", maxWidth: 100, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
          ...
          {profileOpen && (
            <div style={{ ...dropdownBase, width: 200, padding: "0.5rem", overflow: "hidden" }}>
